...
public class MP7CSettings {
	...
	public MP7CSettings() throws IOException, VIRException {
		loadProperties(new File("conf/MP7Cconf.properties"));
	}
	...
	public MP7CSettings(File propertyFile) throws IOException, VIRException {
...
//			CoPhIRv2Reader.setFeatures(fcc);
			...
			m_luceneIndexPathMPG7C = indexprops.getProperty("luceneIndexPath");
			if (m_luceneIndexPathMPG7C.startsWith("*")) {
				m_luceneIndexPathMPG7C = parentDir.getPath() + m_luceneIndexPathMPG7C.substring(1);
			}
