...
public class BoFFieldAdder {
	
	public BoFFieldAdder(){
		
	}
	
	
	public void AddBofStringField(Document doc, String bofString) throws CorruptIndexException, IOException, BoFException{
		
		doc.add(new Field(Parameters.BOFFIELD, bofString, Field.Store.NO, Field.Index.ANALYZED, Field.TermVector.YES));		
	}
