...
public class SAPIRHTMetric implements Metric<IFeaturesCollector> {
...
/*	public final double distance(Image img1, Image img2) {
	...
	public final double distance(IFeaturesCollector f1, IFeaturesCollector f2, double max ) {
		...
		//HT
		dist = HomogeneousTexture.mpeg7XMDistance( (HomogeneousTexture) f1.getFeature(HomogeneousTexture.class), (HomogeneousTexture) f2.getFeature(HomogeneousTexture.class), htOption );
