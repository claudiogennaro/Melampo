...
public class SAPIRSCMetric implements Metric<IFeaturesCollector> {
...
/*	public final double distance(Image img1, Image img2) {
	...
	public final double distance(IFeaturesCollector f1, IFeaturesCollector f2, double max ) {
		...
		//SC
		dist = ScalableColor.mpeg7XMDistance( (ScalableColor) f1.getFeature(ScalableColor.class), (ScalableColor) f2.getFeature(ScalableColor.class) );
