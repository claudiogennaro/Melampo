...
public class SAPIREHMetric implements Metric<IFeaturesCollector> {
...
/*	public final double distance(Image img1, Image img2) {
	...
	public final double distance(IFeaturesCollector f1, IFeaturesCollector f2, double max ) {
		...
		//EH
		dist = EdgeHistogram.mpeg7XMDistance( (EdgeHistogram) f1.getFeature(EdgeHistogram.class), (EdgeHistogram) f2.getFeature(EdgeHistogram.class) );
