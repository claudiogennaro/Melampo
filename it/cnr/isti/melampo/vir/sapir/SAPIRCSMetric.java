...
public class SAPIRCSMetric implements Metric<IFeaturesCollector> {
...
/*	public final double distance(Image img1, Image img2) {
	...
	public final double distance(IFeaturesCollector f1, IFeaturesCollector f2, double max ) {
		...
		//CS
		dist = ColorStructure.mpeg7XMDistance( (ColorStructure) f1.getFeature(ColorStructure.class), (ColorStructure) f2.getFeature(ColorStructure.class) );
